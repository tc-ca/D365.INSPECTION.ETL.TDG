...
(
 ...
 (
   ...
   FROM (
    ...
    WHERE ACTIVITY_TYPE_PARENT_CD IS NULL AND TD045.DATE_DELETED_DTE IS NULL --AND YD101.DATE_DELETED_DTE IS NULL 
   ...
   (
    ...
    FROM [dbo].[YD101_FILE_ACTIVITY_TYPE] YD101
    JOIN TD045_ACTIVITY_TYPE TD045 ON YD101.ACTIVITY_TYPE_CD = TD045.ACTIVITY_TYPE_CD
    WHERE ACTIVITY_TYPE_PARENT_CD IS NOT NULL AND TD045.DATE_DELETED_DTE IS NULL --AND YD101.DATE_DELETED_DTE IS NULL
