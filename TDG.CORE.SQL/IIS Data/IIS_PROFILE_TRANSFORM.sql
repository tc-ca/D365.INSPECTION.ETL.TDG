--CONFIRMATION OF COMPLIANCES	HAVE FROM IIS: YES, CONVERTED: YES
--MODES -						HAVE FROM IIS: YES, CONVERTED: NO
--CLASSES						HAVE FROM IIS: YES, CONVERTED: NO
--QC INDICATORS ON WORK ORDERS	HAVE FROM IIS: YES, CONVERTED: YES[dbo].[YD034_STAKEHOLDER_BUSINESS]
--UN NUMBERS					HAVE FROM IIS: YES, CONVERTED: NO
--BUSINESS CATEGORIES			HAVE FROM IIS: YES, CONVERTED: NO
--INSPECTION REPORTS			HAVE FROM IIS: NO, CONVERTED: NO[dbo].[YD100_ACTIVITY_REPORT]


SELECT STAKEHOLDER_ID, UN_NUMBER 
FROM YD031_STAKEHOLDER_DG_PROFILE YD031;

SELECT * FROM YD100_ACTIVITY_REPORT;
