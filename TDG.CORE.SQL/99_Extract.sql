SELECT * FROM (SELECT * FROM (SELECT DISTINCT 
...
(
    ...
    (
        SELECT STAKEHOLDER_ID, string_agg (BUSINESS_CATEGORY_CD, ', ') WITHIN GROUP (ORDER BY STAKEHOLDER_ID) BUSINESS_CATEGORY_CD
        FROM (
...
(
	...
	ON AD050.STAKEHOLDER_ID = T.STAKEHOLDER_ID AND T.ACTIVE_ADDRESS_DTE = AD050.ACTIVE_ADDRESS_DTE AND T.ADDRESS_TYPE_CD = ADDRESS_TYPE_CD 
    ...
    (
		...
		ON AD050.STAKEHOLDER_ID = T.STAKEHOLDER_ID AND T.ACTIVE_ADDRESS_DTE = AD050.ACTIVE_ADDRESS_DTE
...
--BETA 2 COMPANIES
(
COMPANY.STAKEHOLDER_ID = 1763    OR
COMPANY.STAKEHOLDER_ID = 2382	 OR
COMPANY.STAKEHOLDER_ID = 5558    OR
COMPANY.STAKEHOLDER_ID = 5861    OR
COMPANY.STAKEHOLDER_ID = 8166    OR
COMPANY.STAKEHOLDER_ID = 8860	 OR
COMPANY.STAKEHOLDER_ID = 9170    OR
COMPANY.STAKEHOLDER_ID = 10429	 OR
COMPANY.STAKEHOLDER_ID = 11861	 OR
COMPANY.STAKEHOLDER_ID = 14000   OR
COMPANY.STAKEHOLDER_ID = 14003   OR
COMPANY.STAKEHOLDER_ID = 16805	 OR
COMPANY.STAKEHOLDER_ID = 20918   OR
COMPANY.STAKEHOLDER_ID = 1394500 OR
COMPANY.STAKEHOLDER_ID = 1394839 OR
COMPANY.STAKEHOLDER_ID = 4113015 OR
COMPANY.STAKEHOLDER_ID = 21273--4113311 OR
)

--PNR DATA
--UPPER(ADDRESS.COUNTRY_SUBDIVISION_CD) LIKE '%AB%' OR 
--UPPER(UNREGISTERED_ADDRESS.COUNTRY_SUBDIVISION_CD) LIKE '%AB%' OR 
--UPPER(ADDRESS.COUNTRY_SUBDIVISION_CD) LIKE '%MB%' OR 
--UPPER(UNREGISTERED_ADDRESS.COUNTRY_SUBDIVISION_CD) LIKE '%MB%' OR 
--UPPER(ADDRESS.COUNTRY_SUBDIVISION_CD) LIKE '%SK%' OR 
--UPPER(UNREGISTERED_ADDRESS.COUNTRY_SUBDIVISION_CD) LIKE '%SK%'
