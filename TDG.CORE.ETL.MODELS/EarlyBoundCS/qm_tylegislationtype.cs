...
namespace CrmWebApiEarlyBoundGenerator {
    ...
    public class qm_tylegislationtype : Entity {
        
        public new const string EntityLogicalName = "qm_tylegislationtype";
        
        public new const string EntitySetName = "qm_tylegislationtypes";
        
        public new const string PrimaryIdAttribute = "qm_tylegislationtypeid";
        
        public qm_tylegislationtype() {
        }
        
        public qm_tylegislationtype(ExpandoObject expandoObject) : 
                base(expandoObject) {
        }
        ...
        public Guid? qm_tylegislationtypeId {
            get {
                return this.GetAttributeValue<Guid?>("qm_tylegislationtypeId");
            }
            set {
        ...
        // <summary>
        // Reason for the status of the Legislation Type
        //Raison du statut de l'élément Legislation Type
        // </summary>
        ...
        public class Fields {
            ...
            public const string Id = "qm_tylegislationtypeid";
        }
