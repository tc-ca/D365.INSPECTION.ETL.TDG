...
namespace TDG.CORE.ETL.MODELS.LEGISLATION
{
    public static class JusticeToTCModel
    {
        public static qm_rclegislation ConvertToTCModel (this Regulation justiceModel)
        {
            ...
            newTcModel.qm_InforceDte                   = justiceModel.InforceStartDate.ToDateTime(); //TODO: ensure format is consistent on read
            newTcModel.qm_LastAmendedDte               = justiceModel.LastAmendedDate.ToDateTime();
            ...
            newTcModel.qm_AddtionalMetadataEtxt        = justiceModel.AdditionalMetadata;
